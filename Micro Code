...
#define AIO_USERNAME    "Theja08"
#define AIO_KEY         "aio_NAkZ72J8ZISsDq4Aoyc2UrV6F7U0"

WiFiClient client;

Adafruit_MQTT_Client mqtt(&client, AIO_SERVER, AIO_SERVERPORT, AIO_USERNAME, AIO_KEY);
Adafruit_MQTT_Subscribe message = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/texts");
...
WiFi.mode(WIFI_STA);
WiFiMulti.addAP("TeamMagnus","Feliksclub");
